...
\definecolor{codestr}{rgb}{0.70,0.40,0.15}   % warm orange-brown for strings
\definecolor{codecmt}{rgb}{0.45,0.45,0.45}   % medium gray for comments
\definecolor{codenum}{rgb}{0.10,0.55,0.10}   % green for numbers
\definecolor{codepre}{rgb}{0.55,0.18,0.60}   % purple for preprocessor
\definecolor{codetype}{rgb}{0.15,0.58,0.55}  % teal for C++ types
\usepackage{caption}
\usepackage{tikz}
